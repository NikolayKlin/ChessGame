...
public:
    ...
    int Black_pawn_check(int posx, int posy, int regex, int regey);
    ...
    int Black_RookShah(int ox, int oy, int regex, int regey);
    int Black_ElephantShah(int ox, int oy, int regex, int regey);
